...
{
    // Get the theme data
    wp_enqueue_style('child-understrap-styles', get_stylesheet_directory_uri() . '/css/young.min.css', array(), filemtime(get_stylesheet_directory() . '/css/young.min.css'), 'all');
    wp_enqueue_script('child-understrap-scripts', get_stylesheet_directory_uri() . '/js/young.min.js', [ "jquery" ], filemtime(get_stylesheet_directory() . '/js/young.min.js'), true);
