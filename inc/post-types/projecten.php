...
function projecten()
{
    ...
    $labels = array(
        ...
        'featured_image' => __('Project foto', 'young'),
        'set_featured_image' => __('Kies project foto', 'young'),
        'remove_featured_image' => __('Verwijder project foto', 'young'),
        'use_featured_image' => __('Project foto', 'young'),
        'insert_into_item' => __('Insert into item', 'young'),
        'uploaded_to_this_item' => __('Uploaded voor dit project', 'young'),
